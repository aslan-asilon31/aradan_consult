          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                ...
                Your Ticket: {{ $t->ticket  }}
                @endforeach

                <div>
                    <input type="text" id="textToSpeak"  placeholder="Enter text to speak">
                    <button id="readButton" onclick="speakText()"> <i class="fa fa-bullhorn"></i> </button>
                    <a href="/generate-pdf">Download your ticket</a>
                </div>
...
<script>
    function speakText() {
        const text = document.getElementById('textToSpeak');
        const userName = "{{ auth()->user()->name }}"; // Dapatkan nama pengguna dari Laravel

        // Set nilai dari input dengan nama pengguna
        text.value = userName;
